...
public class MainWindowForm {
  ...
  private void onDownloadBoardsCheckBoxChange(ItemEvent itemEvent) {
    config.setDoBoardDownload(itemEvent.getStateChange() == 1);
    updateTaskLabelIcon(downloadBoardsTaskLabel, config.isDoBoardDownload());
  }

  private void onCheckFileTypesCheckBoxChange(ItemEvent itemEvent) {
    config.setDoFileCheck(itemEvent.getStateChange() == 1);
    updateTaskLabelIcon(checkFileTypesTaskLabel, config.isDoFileCheck());
  }

  private void onOpenTargetOnDoneCheckBoxChange(ItemEvent itemEvent) {
    config.setOpenOnCompletion(itemEvent.getStateChange() == 1);
    updateTaskLabelIcon(openTargetOnDoneTaskLabel, config.isOpenOnCompletion());
  }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.add(checkFileTypesTaskLabel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(16, 16), new Dimension(16, 16), null, 0, false));
    ...
    panel1.add(checkFileTypesCheckBox, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    openTargetOnDoneTaskLabel = new JLabel();
    openTargetOnDoneTaskLabel.setText("");
    panel1.add(openTargetOnDoneTaskLabel, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, new Dimension(16, 16), new Dimension(16, 16), null, 0, false));
    ...
    panel1.add(openTargetOnDoneCheckBox, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
  }
